    ...
    <div class="has-sidebar has-sidebar--v2 wrapper wrapper-1290">
              ...
              <div class="dwld-photo">
                <div class="photo">
                  ...
                  <div class="photo-actions">
                    ...
                    <button class="photo-action delete" type="button"><svg width="28"
                                                                           height="28" viewBox="0 0 28 28" fill="none"
                                                                           xmlns="http://www.w3.org/2000/svg">
                      <path
      ...
      <aside class="sidebar">
        <div class="premium-col sticky-item">
          ...
          <div class="term"> <span>Действует до</span><strong>24 августа 2024</strong></div><a
            class="btn button-xs" href="#">Отключить </a>
        </div>
      </aside>
    </div>
  </main>
