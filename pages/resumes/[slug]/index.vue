    ...
    <div class="bg-wrapper pt">
      ...
      <div class="wrapper wrapper-1290">
        ...
        <div class="favorites-list-container">
          <ResumesSingleLikeList></ResumesSingleLikeList>
        </div>
      </div>
    </div>
    <HomeWorkSection/>
...
<script setup>
import Results from "../../../components/Resumes/Results";
import Resumes from "../../search/resumes";
...
const toggleActionMenuVisibility = (e) => {
  ...
  console.log(isActionMenuShown.value);
