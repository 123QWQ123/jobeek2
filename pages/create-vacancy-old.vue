        ...
        <form class="create-vacancy" action="" name="create-subscribe ">
          <div class="w-box w-box--main w-box-subscribe">
            ...
            <div class="w-box-body">
              <form id="CreateVacancyOldForm" class="create-vacancy__form"  @submit.prevent="onSubmit">

                <CreateVacancyOldProviders/>
                  ...
                  <transition-group name="step">
                    <!-- step one -->
                    <CreateVacancyOldStep01 v-if="isFirstStep" :providers="providers" :class="{'d-block' : isFirstStep}" @set="updateState" @next="goToNextStep"/>

                    <!-- step two -->
                    <CreateVacancyOldStep02 v-if="isSecondStep" :providers="providers" :class="{'d-block' : isFirstStep}" @set="updateState" @next="goToNextStep" @prev="goToPrevStep"/>

                    <!-- step three -->
                    <CreateVacancyOldStep03 v-if="isThirdStep" :providers="providers" :class="{'d-block' : isThirdStep}" @set="updateState" @prev="goToPrevStep"/>
