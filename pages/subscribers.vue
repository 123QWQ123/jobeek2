    ...
    <div class="bg-wrapper pt">
      <div class="wrapper wrapper-1290">
        ...
        <div class="subs-list-container">
          <ul class="subs-list">
              ...
              <div class="subs-card">
                <div class="subs-card-body">
                  <div class="subs-card-name">
                    <strong class="title"
                      >Продавец-консультант и рабоник зала</strong
                    ...
                    <div class="option">
                      <div class="check-block">
                        <div class="checkbox">
                          <input
                            type="checkbox"
                            id="enable-email-notofication"
                          />
                          <div class="checkbox-mask">
                            <img src="~/assets/img/svg/check.svg" alt="#" />
                          </div>
                        </div>
                        <label for="enable-email-notofication"
            ...
            <li>
              <div class="subs-card">
                <div class="subs-card-body">
                  <div class="subs-card-name">
                    <strong class="title">Менеджер среднего звена</strong
          ...
          <button class="create-button">Создать подписку</button>
        </div>
      </div>
    </div>
