        ...
        <div class="list-of-providers">
          <a href="/redirect" class="provider-item">
            <span class="provider-label" :class="{success: isSuccess}">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#f14646" class="bi bi-x" viewBox="0 0 16 16">
          ...
          <a href="/redirect" class="provider-item">
            <span class="provider-label" :class="{success: isSuccess}">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="limegreen" class="bi bi-check" viewBox="0 0 16 16">
