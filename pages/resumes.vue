  ...
  <main class="main cabinet subs-page" role="main">
    ...
    <div class="bg-wrapper pt">
      <div class="wrapper wrapper-1290">
        <h1 class="lk-page-title">Ваши резюме</h1>
        <div class="notification">
          <div class="ic"> <img src="img/svg/crown2.svg" alt="#"></div>
          <div class="notification-text"> <strong class="title">Подключите премиум</strong>
            <p>У вас стоит лимит на создание подписок: 3 шт. Чтобы создавать неограниченное кол-во
              подписок, подключите премиум</p>
          </div><a class="notification-button button-accent" href="#">Подключить </a>
        </div>
        <div class="resume-list-container">
              ...
              <div class="resume-card">
                <div class="resume-card-body">
                  <div class="resume-card-body-col">
                    ...
                    <div class="resume-card-name"> <strong class="title">Продавец-консультант и
                      рабоник зала</strong><span class="location">Омск </span><span
                        class="price">От 1 000 000 ₽</span></div>
                  </div>
                  <div class="resume-card-body-col">
                    <div class="date">с 16 января по 24 марта</div>
                    <div class="resume-counts">
                      <div class="count"> <strong>24</strong><span>Показа</span></div>
                      <div class="count"> <strong>0</strong><span>Просмотров</span></div>
                ...
                <div class="resume-card-moddle">
                  ...
                  <div class="mini-notification"><img src="img/svg/notification.svg" alt="#">
                    <div class="text"><a href="#">Укажите зарплату</a>, чтобы быстрее найти
                      высокооплачиваемую работу </div>
                  </div>
                </div>
                <div class="resume-card-options"><span class="status">Обновлено в 14:12</span>
                  <div class="option-group selector-group">
                    <div class="option">
                      <div class="custom-check-wrap">
                        ...
                        <label for="hh"><img src="img/logos/hhmini.svg"
                    ...
                    <div class="option">
                      <div class="custom-check-wrap">
                        ...
                        <label for="sj"><img src="img/logos/sj.svg"
                                             alt="#"><span>Superjob.ru </span></label>
                      </div>
                    </div>
                  </div>
                  <div class="resume-actions-group">
                    <div class="params-button-container">
                      <button class="resume-action params-button"><svg width="31" height="31"
                        ...
                        <div class="group">
                          <button class="b-action">
                            <div class="card-action"><svg width="28" height="28"
                                                          ...
                                                          xmlns="http://www.w3.org/2000/svg">
                              <path d="M4.02539 23.9749H23.9754" stroke="#5375FD"
                        ...
                        <div class="group">
                          <div class="check-block">
                            <div class="checkbox">
                              ...
                              <div class="checkbox-mask"><img src="img/svg/check.svg"
                                                              alt="#"></div>
                            </div>
                          ...
                          <div class="check-block">
                            ...
                            <label for="enable-email-notification">Подключить E-mail
                              уведомления</label>
                          </div>
                        </div>
                      </div>
                    </div>
                    <button class="resume-action button-md write-message">Написать
                      сообщение</button>
                    <button class="resume-action button-md">1 234 подходящих вакансий </button>
                  </div>
                </div>
              </div>
            </li>
          ...
          <button class="create-button">Создать резюме</button>
        </div>
      </div>
    </div>
