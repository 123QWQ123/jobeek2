              ...
              <div class="resume-card">
                <div class="resume-card-body">
                  <div class="resume-card-body-col">
                    ...
                    <div class="resume-card-name">
                      ...
                      ><span class="price">От 1 000 000 ₽</span>
                    </div>
                  </div>
                  <div class="resume-card-body-col">
                    ...
                    <div class="resume-counts">
                      <div class="count">
                        <strong>24</strong><span>Показа</span>
                      </div>
                      <div class="count">
                        <strong>0</strong><span>Просмотров</span>
                      </div>
                      <div class="count">
                        <strong>0</strong><span>Отклики </span>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="resume-card-moddle">
                  ...
                  <div class="mini-notification">
                    ...
                    <div class="text">
                      <a href="#">Укажите зарплату</a>, чтобы быстрее найти
                      высокооплачиваемую работу
                    </div>
                  </div>
                </div>
                <div class="resume-card-options">
                  <span class="status">Обновлено в 14:12</span>
                  ...
                  <div class="resume-actions-group">
                    <div class="params-button-container">
                      <button class="resume-action params-button">
                        <svg
                          width="31"
                          height="31"
                          viewBox="0 0 31 31"
