        ...
        <div class="favorites-card favorites-card--footer-only">
          <div class="favorites-card-footer">
            <div class="favorites-card-footer-row telephones-row">
              <ul>
                <li> <a class="tel" href="tel: +7 800 550 11 00"> <img src="img/svg/carbon_phone.svg" alt="#">+7 800 550 11 00 </a></li>
                <li> <a class="tel" href="tel: +7 800 550 11 00"> <img src="img/svg/carbon_phone.svg" alt="#">+7 800 550 11 00 </a></li>
                <li> <a class="tel" href="tel: +7 800 550 11 00"> <img src="img/svg/akar-icons_whatsapp-fill.svg" alt="#">+7 800 550 11 00                 </a></li>
              </ul>
            </div>
            <div class="favorites-card-footer-row">
              <div class="group">
                <button class="group-action btn button-md"> Откликнуться</button>
                <button class="group-action btn button-md js-show-contacts" data-default-txt="Показать контакты" data-replacement-text="Скрыть контакты"> Показать контакты</button>
              </div>
              <div class="group">
                <div class="group-action params-button-container">
                  <button class="params-button"><svg width="31" height="31" viewBox="0 0 31 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="params-box">
                    ...
                    <div class="group"><div class="check-block">
                      <div class="checkbox">
                        <input type="checkbox" id="enable-push" checked>
                        <div class="checkbox-mask"><img src="img/svg/check.svg" alt="#"></div>
                      </div>
        ...
        <div class="has-sidebar has-sidebar--v3">
            ...
            <div class="vacancy-single">
              <div class="vacancy-single-head">
                ...
                <div class="adress"> <span>Саратов, улица Зарубина, 167.</span>
                  <button class="on-map"> <img src="img/svg/cil_map.svg" alt="#">Показать на карте</button>
                </div>
          ...
          <aside class="sidebar">
            <div class="company-col sticky-item">
              <div class="company-logo"><img src="img/logos/megafon.svg" alt="#"></div>
              ...
              <div class="grade-box-container">
                ...
                <div class="grade-box">
                  ...
                  <div class="grade-box-text"> <strong>Хорошо</strong><a href="#">12 отзывов     </a></div>
                </div><span class="txt">55% рекомендуют компанию</span>
              </div>
            </div>
          </aside>
        </div>
          ...
          <ul class="favorites-list">
            ...
            <li>
              <div class="favorites-card">
                <div class="favorites-card-head">
                  <div class="company">
                    <div class="company-logo"><img src="img/logos/tele2.svg" alt="#"></div>
                    <div class="company-name"> <a href="#"> Продавец-консультант и рабоник зала</a><span class="count">Мегафон</span></div>
                  </div>
                  <div class="salary">От 1 000 000 ₽        </div>
                </div>
...
import ThePersonalCabinetHeader from "../components/ThePersonalCabinetHeader";
