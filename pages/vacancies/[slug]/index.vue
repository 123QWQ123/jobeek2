                ...
                <div class="group-action params-button-container">
                  ...
                  <div class="params-box" :style="{display: isActionMenuShown}">
                    ...
                    <div class="group">
                      ...
                      <label for="enable-push">Подключить Push-уведомления </label>
                    </div>
                      <div class="check-block">
                        <div class="checkbox">
                        ...
                        <label for="enable-email-notification">Подключить E-mail уведомления</label>
                      </div>
                    </div>
                  </div>
                </div>
...
const toggleContactsVisibility = () => {
  console.log(isContactsShown.value);
...
const isActionMenuShown = ref('none');
const toggleActionMenuVisibility = (e) => {
  if (isActionMenuShown.value === 'block'){
    isActionMenuShown.value = 'none';
  }else{
    isActionMenuShown.value = 'block';
  }
}
</script>
