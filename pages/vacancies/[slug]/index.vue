  ...
  <main class="main cabinet vacansy-page" role="main">
    <div class="bg-wrapper pt">
      ...
      <div class="wrapper wrapper-1290">
          ...
          <div class="favorites-card-footer">
            ...
            <div class="favorites-card-footer-row">
              <div class="group">
                ...
                <button v-if="isContactsShown === 'none'" @click="toggleContactsVisibility"
        ...
        <VacanciesSingleHHContent  v-if="provider === 'hh'" :item="vacancy.hh"></VacanciesSingleHHContent>
        <VacanciesSingleSuperjobContent  v-if="provider === 'superjob'" :item="vacancy.superjob"></VacanciesSingleSuperjobContent>
