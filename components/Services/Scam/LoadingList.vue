  ...
  <div class="skeleton-card mt-4">
    <div class="favorites-card">
      <div class="favorites-card-head align-start">
        <div class="company">
          <div class="company-logo">
            <img src="../../../public/img/operators/megafon.svg" alt="#" />
          </div>
        ...
        <div class="subscribe-min-box">
          <p></p>
          <button class="group-action btn button-md"></button>
        </div>
      </div>
      <div class="favorites-card-body favorites-card-body--brd">
        ...
        <div class="favorites-card-body__text" v-if="1">
          <p>
            <span :class="{ 'w-badge': true, gray: true }">
              <svg
                width="17"
                height="16"
                viewBox="0 0 17 16"
