    ...
    <div class="results-page-content">
      <div class="wrapper">
        <div class="search-head">
          ...
          <div class="col">
            <form class="sort" action="#"> <span>Сортировать:</span><select class="d-select" name="sort"
                                                                            id="sort">
        ...
        <div class="aside-container">
          <aside class="aside">
            <button class="close-aside"><svg xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="filter-container">
              ...
              <div class="filter-box open">
                <div class="filter-box-handle"> <strong>Регион</strong><img
                ...
                <div class="filter-box-body">
                  <div class="check-block-list">
                    <div class="check-block">
                      ...
                      <div class="l-wrap">
                        <label for="m">Москва</label><span class="count">1 200</span>
                      </div>
                    </div>
                    <div class="check-block">
                      <div class="checkbox">
                        <input type="checkbox" id="spb">
                        <div class="checkbox-mask"><img src="~/assets/img/svg/check.svg" alt="#">
                        </div>
                      </div>
                      <div class="l-wrap">
                        <label for="spb">Питер</label><span class="count">200</span>
                      </div>
                    </div>
                    <div class="check-block">
                      <div class="checkbox">
                      ...
                      <div class="l-wrap">
                        <label for="k">Кемерово</label><span class="count">123</span>
                      </div>
                    </div>
                    <div class="check-block">
                      <div class="checkbox">
                      ...
                      <div class="l-wrap">
                        <label for="v">Владикавказ</label><span class="count">1 200</span>
                      </div>
                    </div>
                    <div class="check-block">
                      <div class="checkbox">
                      ...
                      <div class="l-wrap">
                        <label for="o">Онега</label><span class="count">123</span>
                      </div>
                    </div>
                    <div class="check-block">
                      <div class="checkbox">
                      ...
                      <div class="l-wrap">
                        <label for="o2">Онега</label><span class="count">123</span>
                      </div>
                    </div>
                  </div>
              ...
              <div class="filter-box open">
                <div class="filter-box-handle"> <strong>Зарплата</strong><img
                    src="~/assets/img/svg/Arrow-Down.svg" alt="#"></div>
                <div class="filter-box-body">
                  <div class="check-block-list">
                    <div class="check-block">
              ...
              <div class="filter-box open">
                <div class="filter-box-handle"> <strong>Специализации</strong><img
                    src="~/assets/img/svg/Arrow-Down.svg" alt="#"></div>
                <div class="filter-box-body">
                  <div class="check-block-list">
                    <div class="check-block">
                      ...
                      <div class="l-wrap">
                        <label for="s1">Специализация 1</label><span class="count">1
                                                        200</span>
                      </div>
                    </div>
                    <div class="check-block">
                      ...
                      <div class="l-wrap">
                        <label for="s2">Специализация 2</label><span
                    ...
                    <div class="check-block">
                      ...
                      <div class="l-wrap">
                        <label for="s3">Специализация 3</label><span
                    ...
                    <div class="check-block">
                      ...
                      <div class="l-wrap">
                        <label for="s4">Специализация 4</label><span
                          class="count">123</span>
                      </div>
                    </div>
                    <div class="check-block">
                      ...
                      <div class="l-wrap">
                        <label for="s5">Специализация 5 </label><span
                          class="count">123</span>
                      </div>
                    </div>
                    <div class="check-block">
                      ...
                      <div class="l-wrap">
                        <label for="s6">Специализация 6 </label><span
                          class="count">123</span>
                      </div>
                    </div>
                    <div class="check-block">
                      ...
                      <div class="l-wrap">
                        <label for="s7">Специализация 7 </label><span
                          class="count">123</span>
                      </div>
                    </div>
                    <div class="check-block">
                      ...
                      <div class="l-wrap">
                        <label for="s8">Специализация 8 </label><span
                          class="count">123</span>
                      </div>
                    </div>
                    <div class="check-block">
                      ...
                      <div class="l-wrap">
                        <label for="s9">Специализация 9 </label><span
                          class="count">123</span>
                      </div>
                    </div>
                    <div class="check-block">
                      ...
                      <div class="l-wrap">
                        <label for="s10">Специализация 10 </label><span
                          class="count">123</span>
                      </div>
                    </div>
                  </div>
              ...
              <div class="filter-box">
                <div class="filter-box-handle"> <strong>Тип вакансии</strong><img
                    src="~/assets/img/svg/Arrow-Down.svg" alt="#"></div>
                <div class="filter-box-body">
                  <div class="check-block">
                    <div class="checkbox">
                    ...
                    <div class="l-wrap">
                      <label for="t1">Тип 1</label><span class="count">1 200</span>
                    </div>
                  </div>
                  <div class="check-block">
                    <div class="checkbox">
                    ...
                    <div class="l-wrap">
                      <label for="t2">Тип 2</label><span class="count">200</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="content">
              ...
              <li>
                <div class="favorites-card">
                  ...
                  <div class="favorites-card-body">
                    <div class="time-location"><span>9:55</span><strong>Москва</strong></div>
                    <p>Торговая сеть «Перекрёсток» – объединяем лучших!<br> «Перекрёсток»
                      предлагает покупателям только лучшее, потому что у нас сильная команда
                      профессионалов!Наши сотрудники - самая большая ценность для компании. Мы
                      предлагаем стабильную работу.</p>
                  </div>
                    ...
                    <div class="favorites-card-footer-row">
                      ...
                      <div class="group">
                        <div class="group-action params-button-container">
                          <button class="params-button"><svg width="31" height="31"
                          ...
                          <div class="params-box">
                            <div class="group">
                              <button class="b-action">
                                <div class="card-action"><svg width="28" height="28"
                                                              viewBox="0 0 28 28" fill="none"
                                                              xmlns="http://www.w3.org/2000/svg">
                                  <path d="M4.02539 23.9749H23.9754"
                                        stroke="#5375FD" stroke-width="1.5"
                              ...
                              <button class="b-action">
                                <div class="card-action"><svg width="25" height="25"
                            ...
                            <div class="group">
                              <div class="check-block">
                                <div class="checkbox">
                                  ...
                                  <div class="checkbox-mask"><img
                                      src="~/assets/img/svg/check.svg" alt="#"></div>
                                </div>
                                <label for="enable-push">Подключить Push-уведомления
                                </label>
                              </div>
                              <div class="check-block">
                                <div class="checkbox">
                                ...
                                <label for="enable-email-notification">Подключить
                                  E-mail уведомления</label>
                              </div>
                            </div>
                          </div>
                        </div><button class="group-action ic-btn fav-btn">
            ...
            <button class="create-button show-more">Показать еще<img src="~/assets/img/svg/Arrow-Down2.svg"
                                                                     alt="#"></button>
          </div>
        </div>
      </div>
