          ...
          <div class="custom-select-wrapper">
            <div class="custom-select">
              ...
              <div class="custom-options">
                <div class="custom-option" data-value="Resume1">
                  <input type="checkbox" id="resume1" /><label for="resume1"
                    >Резюме 1</label
                  >
                </div>
                <div class="custom-option" data-value="Resume2">
                  <input type="checkbox" id="resume2" /><label for="resume2"
                    >Резюме 2</label
                  >
                </div>
                <div class="custom-option" data-value="Resume3">
                  <input type="checkbox" id="resume3" /><label for="resume3"
                    >Резюме 3</label
                  >
                </div>
              </div>
