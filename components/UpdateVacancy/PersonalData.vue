    ...
    <div class="w-box-body" :class="{ collapse: isCollapsed }">
            ...
            <div class="photo-actions">
              ...
              >
                ...
                >
                  ...
                  />
                  <path
                    d="M14.2583 6.79933L20.0333 12.5743M14.2583 6.79933L17.5577 3.5L23.3327 9.275L20.0333 12.5743L14.2583 6.79933ZM14.2583 6.79933L7.71683 13.3408C7.49803 13.5596 7.37507 13.8563 7.375 14.1657V19.4577H12.667C12.9764 19.4576 13.2731 19.3346 13.4918 19.1158L20.0333 12.5743L14.2583 6.79933Z"
                    stroke="#D2D2D2"
                    stroke-width="1.5"
                    stroke-linecap="round"
                    stroke-linejoin="round"
          ...
          <div class="check-block mt-2">
            <div class="checkbox">
              <input
                type="checkbox"
                id="hide_birthday"
                v-model.number="state.hide_birthday.val"
                @focusin="() => (errors.hide_birthday = '')"
              />
            ...
            <label for="hide_birthday" class="fs-14"
              >Не показать даты рождения</label
            >
          </div>
      ...
      <div class="input-row">
        ...
        <div class="input-wrapper mt-2">
          <SelectWithSearch
            :options="cityOptions"
            v-model.number="state.city_id.val"
          ...
          <div class="check-block mt-2">
            <div class="checkbox">
              <input
                type="checkbox"
                id="ready-to-relocate"
                v-model.number="state.is_relocatable.val"
                @focusin="() => (errors.is_relocatable = '')"
              />
              <div class="checkbox-mask">
                <img src="~/assets/img/svg/check.svg" alt="#" />
              </div>
            </div>
            <label for="ready-to-relocate" class="fs-14"
      ...
      <br />
      <CreateResumeSocialNetworksContent
        v-model="state.social_networks.val"
        :errors="errors.social_networks"
      ></CreateResumeSocialNetworksContent>
    </div>
  </div>
</template>
...
const save = async () => {
  if (isChanged.value) {
    ...
    if (draftID.value) {
      ...
      const unrefed = state.social_networks.val.map((item) => ({
        type: item.type,
        value: item.value,
      }));
...
const isCompleted = computed(() => {
  ...
  if (myResume) {
    return (
      ...
      myResume.city_id &&
      myResume.phone &&
      myResume.phone_time_start &&
      myResume.phone_time_end &&
      myResume.email
    );
  }
  return false;
