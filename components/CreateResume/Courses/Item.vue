        ...
        <div class="input-row">
          ...
          <div class="input-wrapper">
            <input
              ...
              placeholder="Введите"
              required
              v-model="state.certificate_url.val"
              @focusin="() => (errors.certificate_url = '')"
            />
            <div class="text-danger d-block" v-if="errors.certificate_url">
...
const isMoreFields = computed(() => state.type_id.val >= 117);
