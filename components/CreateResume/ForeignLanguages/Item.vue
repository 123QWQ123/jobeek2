<template>
  <div class="row position-relative">
    <span class="position-absolute absoluted_icon position-delete-icon delete-icon-item" @click="deleteItem">
      <svg
      ...
      <div class="c2 w-100">
        <div class="input-wrapper">
          <SelectWithSearch
            ...
            v-model.number="state.language_id.val"
          ></SelectWithSearch>
        ...
        <div class="input-wrapper">
          <CustomSelect
            ...
            v-model.number="state.level_id.val"
          ></CustomSelect>
