      ...
      <div class="resume-card-body">
        <div class="resume-card-body-col">
          ...
          <div class="resume-card-name">
            ...
            <span class="price">
              От {{ $formatNumber(salaryAmount, {}) }} {{ currency }}
            </span>
          </div>
        </div>
        <div class="resume-card-body-col">
...
const hhProviderConnected = computed(() => {
  return providers.value && providers.value.hh === true;
});
...
const superjobProviderConnected = computed(() => {
  return !!providers.value.superjob;
});
...
const onRestore = async (id) => {
  ...
  navigateTo({ name: "my-vacancies", query: { status: "archived" } });
};
