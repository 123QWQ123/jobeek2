    ...
    <div class="resume-card">
      <div class="resume-card-body">
        <div class="resume-card-body-col">
          ...
          <div class="resume-card-name">
            <nuxt-link
              :to="{ name: 'create-vacancy', query: { vacancy_id: item.id } }"
              class="title"
            >
              {{ item.name }}
            </nuxt-link>
        ...
        <div class="resume-card-body-col">
          ...
          <div class="resume-counts">
            <div class="count cursor-pointer" @click.prevent="toggleViews">
              <strong class="js-view-stat">{{ totalViewCount }}</strong
              ><span>Показы</span>
            </div>
            <!--            <div class="count">-->
      ...
      <div class="resume-card-stats active" v-if="isViewsShown">
        <div class="resume-card-stats-head">
          ...
          <button class="close close-stats" @click.preven="toggleViews">
            Скрыть
          </button>
        </div>
        <div class="resume-card-stats-body">
          ...
          <div class="stat">
            <strong>{{ hhTotalCount }}</strong
            ><a href="#"><img src="~/assets/img/svg/hh.svg" alt="#" />Hh.ru </a>
          </div>
          <div class="stat">
            <strong>{{ superjobTotalCount }}</strong
            ><a href="#"
              ><img src="~/assets/img/svg/sb.svg" alt="#" />Superjob.ru
            </a>
          </div>
        </div>
      </div>
      ...
      <div class="resume-card-options">
        ...
        <div class="d-inline-flex ms-0 ms-lg-auto">
          <div
            class="d-inline-flex flex-column flex-lg-row mt-4 mt-lg-0 ms-sm-4"
          >
        ...
        <div
          class="params-button-container ms-auto"
