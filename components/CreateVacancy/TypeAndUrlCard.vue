    ...
    <transition>
      <div class="w-box-body" :class="{ collapse: isCollapsed }">
        ...
        <div class="input-row" v-if="isAnonymous">
          ...
          <div class="input-wrapper mt-2">
            <input
              v-model="state.custom_employer_name.val"
              @focusin="() => (errors.custom_employer_name = '')"
            />
        ...
        <div class="input-row" v-if="isDirect">
          ...
          <div class="input-wrapper mt-2">
            <input
              v-model="state.response_url.val"
              @focusin="() => (errors.response_url = '')"
            />
...
const vacancyTypeOptions = computed(() => {
  return dictionaryStore.vacancy_types.map((item) => ({
    name: item.name,
    value: item.id,
  }));
});
