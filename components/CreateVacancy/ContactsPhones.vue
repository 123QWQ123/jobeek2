  ...
  <div v-if="!isHidden">
    ...
    <div class="input-row mt-0">
      ...
      <div class="input-wrapper mt-2">
        <textarea
          class="form-control"
          v-model="state.phone_comment.val"
          @focusin="onFocusInput('phone_comment')"
        >
        </textarea>
    ...
    <div class="row" v-if="isAdditionalPhoneShown">
      <div class="input-row">
        ...
        <div class="input-wrapper mt-2">
          <input
            ref="additional_phone_element"
            @focusin="onFocusInput('additional_phone')"
          />
      ...
      <div class="input-row mt-0">
        ...
        <div class="input-wrapper mt-2">
          <textarea
            class="form-control"
            v-model="state.additional_phone_comment.val"
            @focusin="onFocusInput('additional_phone_comment')"
          >
          </textarea>
          <div
            class="text-danger d-block"
            v-if="errors.additional_phone_comment"
          >
