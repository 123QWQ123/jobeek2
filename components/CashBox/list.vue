          ...
          <div class="message-item">
            ...
            <div class="col-wrap">
              <div class="col col-body">
                ...
                <span v-if="!receipt.valid" class="error-message small">{{
                  receipt.receipt
                }}</span>
              </div>
            </div>
          ...
          <div class="message-content">
            ...
            <div class="message-txt">
              <div class="message-txt-item">
                ...
                <p>Уважаемый клиент, оплата Премиум доступа прошла успешно, чек об оплате вы можете получить по ссылке:
                  <a href="#">Получить чек оплаты</a>
                </p>
              </div>
              <button class="button-accent">Посмотреть чек</button>
              </div>
            </div>
          </div>
