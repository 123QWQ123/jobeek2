      ...
      <div class="resume-card-body">
        <div class="resume-card-body-col">
          ...
          <div class="resume-card-name">
            ...
            <span class="price" v-if="item.salary_from"
              >От {{ $formatNumber(item.salary_from) }} ₽</span
            >
            <span class="price" v-else
              >До {{ $formatNumber(item.salary_to) }} ₽</span
            >
          </div>
        </div>
        <div class="resume-card-body-col">
          <div class="date">
            с {{ published_date.format("D") }}
          ...
          <div class="resume-counts">
            ...
            <div class="count">
              <strong>{{ item.unread_responses }}</strong
              ><span>Непрочитанные отклики</span>
            </div>
          </div>
        </div>
      </div>
