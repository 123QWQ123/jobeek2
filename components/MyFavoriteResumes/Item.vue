  ...
  <li>
    <div class="favorites-card">
      ...
      <div class="favorites-card-footer">
        <div class="favorites-card-footer-row telephones-row" :style="{display: isContactVisibility}">
          <ul>
            <li>
...
<script setup>
const isContactVisibility = ref('none');

const toggleContactVisibility = () => {
  if (isContactVisibility.value === 'block'){
    isContactVisibility.value = 'none';
  }else{
    isContactVisibility.value = 'block';
  }
}
