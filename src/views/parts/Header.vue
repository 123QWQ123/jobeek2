<template>
  ...
  <div v-if="this.isAuthenticated()" class="lk-header">
      ...
      <div class="header-wrapper">
        ...
        <div class="profile-action">
          ...
          <button class="profile-button" type="button">
            ...
            >
              <rect width="46" height="46" rx="8" fill="#6886FF"></rect>
              <path
      ...
      <div class="header-wrapper">
        ...
        <nav class="main-navigation">
          ...
          <ul>
            ...
            <li>
              <a href="#"> <span>Резюме</span></a>
            </li>
            <li>
              <a href="#"> <span>Вакансии</span></a>
            </li>
            <li>
              <a href="#"> <span>Избранные</span></a>
            </li>
            <li>
              <a href="#"> <span>Подписки</span></a>
            </li>
            <li>
              <a href="#"> <span>Сообщения</span></a>
            </li>
            <li>
              <a href="#"> <span>Советы</span></a>
            </li>
            <li>
