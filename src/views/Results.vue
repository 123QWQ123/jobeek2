    ...
    <div class="wrapper">
      ...
      <div class="aside-container">
              ...
              <div class="filter-box-body">
                <div class="check-block-list">
                  <div class="check-block">
                    ...
                    <div class="l-wrap">
                      <label for="zp">С указанной зп</label
                      ><span class="count">1 200</span>
                    </div>
                  </div>
                  <div class="check-block">
              ...
              <div class="filter-box-body">
                <div class="check-block-list">
                  <div class="check-block">
                    ...
                    <div class="l-wrap">
                      <label for="s1">Специализация 1</label
                      ><span class="count">1 200</span>
                    </div>
                  </div>
                  <div class="check-block">
                    ...
                    <div class="l-wrap">
                      <label for="s2">Специализация 2</label
                      ><span class="count">200</span>
                    </div>
                  </div>
                  <div class="check-block">
                    ...
                    <div class="l-wrap">
                      <label for="s3">Специализация 3</label
                      ><span class="count">123</span>
                    </div>
                  </div>
                  <div class="check-block">
                    ...
                    <div class="l-wrap">
                      <label for="s4">Специализация 4</label
                      ><span class="count">123</span>
                    </div>
                  </div>
                  <div class="check-block">
                    ...
                    <div class="l-wrap">
                      <label for="s5">Специализация 5 </label
                      ><span class="count">123</span>
                    </div>
                  </div>
                  <div class="check-block">
                    ...
                    <div class="l-wrap">
                      <label for="s6">Специализация 6 </label
                      ><span class="count">123</span>
                    </div>
                  </div>
                  <div class="check-block">
                    ...
                    <div class="l-wrap">
                      <label for="s7">Специализация 7 </label
                      ><span class="count">123</span>
                    </div>
                  </div>
                  <div class="check-block">
                    ...
                    <div class="l-wrap">
                      <label for="s8">Специализация 8 </label
                      ><span class="count">123</span>
                    </div>
                  </div>
                  <div class="check-block">
                    ...
                    <div class="l-wrap">
                      <label for="s9">Специализация 9 </label
                      ><span class="count">123</span>
                    </div>
                  </div>
                  <div class="check-block">
                    ...
                    <div class="l-wrap">
                      <label for="s10">Специализация 10 </label
                      ><span class="count">123</span>
                    </div>
                  </div>
                </div>
        ...
        <div class="content">
            ...
            <li>
              <div class="favorites-card">
                ...
                <div class="favorites-card-body">
                  ...
                  <p>
                    Торговая сеть «Перекрёсток» – объединяем лучших!<br />
                    «Перекрёсток» предлагает покупателям только лучшее, потому
                    что у нас сильная команда профессионалов!Наши сотрудники -
                    самая большая ценность для компании. Мы предлагаем
                    стабильную работу.
                  </p>
                </div>
          ...
          <button class="create-button show-more">
            Показать еще<img src="@/assets/img/svg/Arrow-Down2.svg" alt="#" />
          </button>
        </div>
      </div>
    </div>
